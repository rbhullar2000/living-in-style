...
export const properties: Property[] = [
  {
   ...
   // rating: 4.9,
    ...
    description:
      "description:
  comment: "This elegant residence at L’Hermitage Hotel & Residences offers the perfect blend of luxury and convenience in the heart of downtown Vancouver. Situated at 788 Richards Street, this beautifully designed condo features a fully equipped kitchen with stainless steel appliances, an open-air balcony, and sophisticated furnishings that create a modern, welcoming atmosphere. <p> The residence showcases thoughtful design elements such as hardwood flooring, floor-to-ceiling windows, and refined lighting accents that enhance every space. The open-concept layout allows natural light to flow throughout, creating a bright and airy environment ideal for both relaxation and entertaining. Whether you’re preparing dinner in the gourmet kitchen or enjoying a quiet morning coffee on the balcony, this suite provides an elevated living experience. <p> Residents enjoy exclusive access to L’Hermitage Hotel’s renowned amenities, including a state-of-the-art fitness centre, a beautifully appointed library, an elegant resident lounge, and a tranquil rooftop garden terrace — perfect for reading, socializing, or simply unwinding above the city. The hotel’s 24-hour concierge and professional staff ensure every detail is taken care of, offering true peace of mind. <p> Step outside and you’ll find yourself surrounded by Vancouver’s most desirable attractions and conveniences. Stroll to Café Medina for brunch, pick up essentials from IGA Marketplace, or enjoy coffee at Tim Hortons — all just moments from your door. The neighbourhood is also home to several of Vancouver’s best salons, restaurants, and boutique shops, giving you endless options for dining and leisure. <p> Within minutes, you can walk to Yaletown, BC Place, Rogers Arena, and the Vancouver Public Library, or explore the vibrant Granville Entertainment District for an evening out. Whether you’re visiting Vancouver for business, relocation, or an extended stay, this premium condo at L’Hermitage Residences combines the prestige of hotel-style living with the privacy of a home. <p> Offering both sophistication and comfort, it stands as one of the city’s most desirable addresses — a sanctuary of style, convenience, and understated luxury in the heart of downtown.",
    amenities: [
      "High-speed WiFi",
      "50 inch television",
