...
export const properties: Property[] = [
  {
    id: "LHermitage",
    title: "Luxury 1-Bedroom Condo at L'Hermitage Hotel & Residences (1-Queen Bed/1-Sofa Bed)",
    ...
    guests: 4,
   description: `
This elegant residence at L'Hermitage Hotel & Residences offers the perfect blend of luxury, comfort, and convenience in the heart of downtown Vancouver. Situated at 788 Richards Street, this beautifully appointed 1-bedroom suite features a fully equipped gourmet kitchen with stainless steel appliances, an open-air balcony, and sophisticated furnishings that create a warm, modern atmosphere. The home comfortably sleeps up to four guests, with a plush queen bed in the primary bedroom and a high-quality sofa bed in the living area for added flexibility.<p>Thoughtful interior details — including hardwood flooring, expansive windows, refined lighting accents, and an open-concept layout — fill the suite with natural light and a bright, airy sense of space. Whether you're preparing meals in the chef-inspired kitchen or enjoying a quiet morning coffee on the balcony, this residence offers an elevated living experience suited for both relaxation and entertaining.</p><p>Residents enjoy exclusive access to L'Hermitage Hotel’s renowned amenities, including a fully equipped fitness centre, a beautifully designed library, an elegant resident lounge, and a serene rooftop garden terrace — a private urban oasis ideal for reading, socializing, or unwinding above the city. With a dedicated 24-hour concierge and exceptional hotel staff, every detail of your stay is handled with professionalism and care.</p><p>Experience the heart and soul of the property in L’Orangerie, L'Hermitage’s signature lounge. Offering seasonal cuisine, regional wines, handcrafted cocktails, and the renowned High Tea service with delicate bites and premium teas, it provides a luxurious and timeless setting for relaxation and connection.</p><p>Step outside your door and you’re surrounded by Vancouver’s most desirable amenities. Enjoy brunch at Café Medina, pick up essentials from IGA Marketplace, or grab a coffee from Tim Hortons — all just moments away. The neighbourhood is also home to some of Vancouver’s best salons, restaurants, and boutique shops, giving you endless options for dining, shopping, and leisure within a short stroll.</p>
`,
    amenities: [  
      "Fully Furnished Suite with 1 Queen Bed + 1 Sofa Bed",
      "24/7 Concierge Service",
      "L'Orangerie at L'Hermitage, Café Medina, IGA Marketplace, Tim Hortons (On-Site Amenities)",
      "High-Speed WiFi",
  ...
  },
  {
    ...
    availability: "Brand New Condo - Taking bookings for Spring 2026",
    images: [
