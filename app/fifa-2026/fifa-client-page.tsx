          ...
          <div className="container relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg mb-8 text-blue-200 max-w-2xl mx-auto">
                Premium 1-Bedroom Condo at L’Hermitage Residences - 1-Queen Bed / 1-Sofa Bed — just a 10-minute walk to BC Place. Steps from SkyTrain, Yaletown, and Robson shopping. Exclusive event-period pricing available for media crews, FIFA staff, and corporate sponsors.
              </p>
            ...
            <div className="max-w-4xl mx-auto">
                  ...
                  <CardContent className="text-center">
                    ...
                    <div className="text-gray-700 text-sm mb-8 max-w-2xl mx-auto leading-relaxed space-y-2">
                      ...
                      <p className="text-xs text-gray-600">
                        ...
                        $39,000. Full June + July (60 days) tournament packages available up to $75,000 depending on
              ...
              <div className="mt-8 p-6 bg-blue-50 dark:bg-blue-950 rounded-lg text-center">
                <p className="text-sm text-muted-foreground mb-2">
                  ...
                  June stay (30 days) might start at ~$39k; full June-July (60 days) packages available up to ~$75k.
